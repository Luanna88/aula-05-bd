...
public class InserirDados extends JFrame{
	...
	public InserirDados() throws SQLException{
		...
		try{
			...
			st.executeUpdate ("INSERT INTO tabelaProdutos (codProduto,produto) values(1,'Arroz');");
			st.executeUpdate ("INSERT INTO tabelaProdutos (codProduto,produto) values(2,'Feijão');");
			st.executeUpdate ("INSERT INTO tabelaProdutos (codProduto,produto) values(3,'Macarrão');");
		}catch(SQLException eSQL){
